...
from staxfattmerchantapi.http.proxy_settings import (
    ProxySettings,
)
from staxfattmerchantapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://apiprod.fattlabs.com",
        },
        Environment.ENVIRONMENT2: {
            Server.DEFAULT: "https://apidev.fattlabs.com",
        },
    }
